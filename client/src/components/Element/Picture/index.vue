<template>
  <div class='wrap' @mousedown="mousedown" @mouseup="mouseup">
    <img v-if="fileType==='pic'" @dragstart="dragstart" style="width:100%;height:100%;" :src="element.imgSrc">
    <video v-if="fileType==='video'" @dragstart="dragstart" style="width:100%;height:100%;" :src="element.videoSrc"/>
...
<script>
    ...
    export default{
      ...
      methods: {
        // 处理元素拖动
        move () {
          document.querySelector('.layout-container').onmousemove = (event) => {
        ...
        // 处理元素伸缩
        scaleMousemove () {
          document.querySelector('.layout-container').onmouseup = (event) => {
